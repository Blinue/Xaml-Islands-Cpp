...
static const wchar_t* RESOURCE_MAP_ID = L"XamlIslandsCpp/Resources";
...
void RootPage::InitializeComponent() {
	...
	StringResTextBlock1().Text(resourceLoader.GetString(L"Moon1"));
	StringResTextBlock2().Text(resourceLoader.GetString(L"Moon2"));
}
